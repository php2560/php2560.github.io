...
##  `r advdate(mon, 12)`: Working with Dplyr and Tidyr
...
##  `r advdate(mon, 13)`: Graphics in R
...
##  `r advdate(mon, 14)`: Package Building in R

- Creating packages in R
- *Required Readings*:
    - [R Packages](http://r-pkgs.had.co.nz/)

## `r advdate(mon, 15)`: Package Building in R Continued & Shiny Apps
